...
SEARCH_TOP_N=1
SEARCH_URL=http://10.241.148.44:42354
LIMIT_IMAGES=10
...
PROJECT_NAME=EasyR1
EXPERIMENT_NAME=qwen2_5_vl_7b_doc_agent_turn-level-ppo_bi-level-gae-mask-without-temp_01reward_new-metrics
PROMPT_KEY=question
...
MIN_PIXELS=261070
MAX_TURN_NUM=5
TRAIN_DATA_PATH=/mnt/vast-kisski/projects/kisski-sub-doc-understanding/EasyR1/dataset/Doc_Agent/new_new_train.parquet  # your train data path here
...
srun --overlap --nodes=1 --ntasks=1 -w "$head_node"  /bin/bash -c \
  ...
  && python -m verl.trainer.main \
    ...
    worker.critic.model.model_path=${MODEL_PATH} \
    worker.critic.global_batch_size=${GLOBAL_BATCH_SIZE} \
    worker.critic.micro_batch_size_per_device_for_update=${MICRO_BATCH_SIZE_PER_DEVICE_FOR_UPDATE} \
    worker.critic.micro_batch_size_per_device_for_experience=${MICRO_BATCH_SIZE_PER_DEVICE_FOR_EXPERIENCE} \
...
#    trainer.load_checkpoint_path=/mnt/vast-kisski/projects/kisski-sub-doc-understanding/EasyR1/checkpoints/EasyR1/qwen2_5_vl_7b_doc_agent_turn-level-ppo_bi-level-gae-mask-with-temp_new_reward_kl-reward/global_step_20"
