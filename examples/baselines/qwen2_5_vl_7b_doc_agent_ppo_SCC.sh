...
SEARCH_TOP_N=1
SEARCH_URL=http://10.241.149.13:42354
LIMIT_IMAGES=10
...
PROJECT_NAME=EasyR1
EXPERIMENT_NAME=qwen2_5_vl_7b_doc_agent_turn-level-ppo_bi-level-gae-mask-with-temp
PROMPT_KEY=question
...
SAVE_PATH=/scratch1/projects/scc_ulsb_fe/yang/EasyR1/qwen2_5_vl_7b_doc_agent_ppo_bi-level-with-temp
